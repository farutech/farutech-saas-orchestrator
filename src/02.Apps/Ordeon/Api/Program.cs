...
using Farutech.Apps.Ordeon.Infrastructure.Services;
using System.Text;
...
// Hardening & Auditing
builder.Services.AddExceptionHandler<Farutech.Apps.Ordeon.API.Middleware.GlobalExceptionHandler>();
builder.Services.AddProblemDetails();
builder.Services.AddScoped<Farutech.Apps.Ordeon.Infrastructure.Persistence.Interceptors.AuditInterceptor>();

// Database
builder.Services.AddDbContext<OrdeonDbContext>((sp, options) =>
{
    var configuration = sp.GetRequiredService<IConfiguration>();
    var auditInterceptor = sp.GetRequiredService<Farutech.Apps.Ordeon.Infrastructure.Persistence.Interceptors.AuditInterceptor>();
...
if (runMigrations)
{
    try
    {
        ...
        await Farutech.Apps.Ordeon.Infrastructure.DatabaseMigrator.MigrateAsync(app.Services, app.Logger);
